...
def calculate_breadth_above_50dma(universe_tickers: list = None) -> dict:
    ...
    if universe_tickers is None:
        # Use a representative ~30-stock proxy of the SET50 sectors
        universe_tickers = [
            ...
            "HMPRO.BK", "INTUCH.BK", "IVL.BK", "KBANK.BK", "KCE.BK", "KKP.BK", "KTB.BK", "KTC.BK", 
            "LH.BK", "MINT.BK", "MTC.BK", "OR.BK", "OSP.BK", "OTP.BK", "PTT.BK", "PTTEP.BK", 
            "PTTGC.BK", "RATCH.BK", "SCB.BK", "SCC.BK", "SCGP.BK", "TIDLOR.BK", "TISCO.BK", 

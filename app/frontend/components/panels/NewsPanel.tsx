...
const MOCK_NEWS: NewsItem[] = [
  ...
  {
    id: 3,
    headline: "DEMO: NVIDIA reports record Q4 revenue of $39.3B, up 78% YoY, beating estimates by $2.1B. Data center surges on AI chip demand. Stock +8% pre-market on strong FY2026 guidance and $10B buyback announcement.",
    source: "Bloomberg",
    time: "5h ago",
    sentiment: "bullish",
  },
